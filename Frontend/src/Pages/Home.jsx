      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white ">
        <Link to={"/signup"}>
          <div className=" group mx-auto mt-16 w-fit rounded-full bg-richblack-800 p-1 font-bold text-richblack-200 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 hover:drop-shadow-none">
            <div className="flex flex-row items-center gap-2 z-0 rounded-full px-10 py-[5px] transition-all duration-200 group-hover:bg-richblack-900">
        ...
        <div>
          <CodeBlocks
            ...
            backgroundGradient={
              <div className="w-72 h-72 rounded-full bg-[radial-gradient(circle_at_20%_10%,#F1C27D_30%,#8B4513_20%,transparent_100%)] blur-2xl absolute mix-blend-overlay"></div>
            }
        ...
        <div>
          <CodeBlocks
            ...
            backgroundGradient={
              <div className="w-72 h-72 rounded-full bg-[radial-gradient(circle_at_20%_10%,#B3E0F2_10%,#118AB2_30%,transparent_100%)] blur-2xl absolute mix-blend-overlay"></div>
            }
          />
        </div>
        <ExploreMore/>
