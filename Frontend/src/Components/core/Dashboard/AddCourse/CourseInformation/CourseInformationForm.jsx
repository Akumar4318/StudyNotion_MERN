...
{/* courseCategory */}
      <div className="flex flex-col space-y-2">
        ...
        {errors.courseCategory && <span className="ml-2 text-xs tracking-wide text-pink-200">CourseCategory is required</span>}
      </div>

      {/* //NOTE - Create a custom componeent for handling tagse input */}

      <ChipInput
        label="tags"
        name="courseTags"
        placeholder="Enter yor tags and press enter"
        error={errors}
        setValue={setValue}
        getValues={getValues}
        register={register}
...
{/* Benefits of the course */}
 ...
 {/* Requirements/Instructions */}
      ...
      <div className="flex justify-end gap-x-2">
        ...
        <IconBtn disabled={loading} text={!editCourse ? "Next" : "Save Changes"} > <MdNavigateNext />
        </IconBtn>
      </div>
    </form>
  );
